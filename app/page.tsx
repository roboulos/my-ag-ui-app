  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="grid grid-cols-1 lg:grid-cols-5 h-screen">
        ...
        {/* Original UI - 40% width on desktop */}
        ...
        <div className="mt-12 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6">
          ...
          <ul className="space-y-2 text-blue-800 dark:text-blue-200">
            ...
            <li>• &quot;Show me the revenue chart&quot;</li>
            <li>• &quot;Display our key business metrics&quot;</li>
            <li>• &quot;What&apos;s our market share?&quot;</li>
            <li>• &quot;Show growth trends&quot;</li>
          </ul>
        </div>
